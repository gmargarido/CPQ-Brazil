Sub GaxetaVedSup(item_partnumber as String)
	...
	If CheckType(item_partnumber) = "Knife Valve" Then
		...
		var = Select "Gaxeta" from /* CORPO_GUILHOTINA */ where Trim Code = TrimCorpo(item_partnumber)
	...
	ElseIf Serie(item_partnumber) = "1A"
		...
		var = Select "Material" from /* GAXETA_1A */ where Gaxeta = TrimGaxeta(item_partnumber)
	Else	
		'Tabla GAXETA - Oja "Dados" > AI1:AJ7
		var = Select "Gaxeta" from /* GAXETA */ where Cód = TrimGaxeta(item_partnumber)	
	End If
