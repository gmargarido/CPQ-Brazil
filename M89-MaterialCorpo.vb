Sub MaterialCorpo(item_partnumber as String)
	...
	If CheckType(item_partnumber) = "Knife Valve" Then
		...
		var = Select "Corpo" from /* CORPO_GUILHOTINA */ where Trim Code = TrimCorpo(item_partnumber)
	...
	ElseIf Serie(item_partnumber) = "19"
		...
		var = Select "Material" from /* CORPO_S19 */ where Corpo = TrimCorpo(item_partnumber)
	ElseIf Serie(item_partnumber) = "1A"
		'Es necesario utilizar la query abajo en la tabla CORPO_1A - Celdas CT1:CW25
		var = Select "Material" from /* CORPO_1A */ where Corpo = TrimCorpo(item_partnumber)
	Else
		'Es necesario utilizar la query abajo en la tabla CORPO - Celdas R1:U13
		var = Select "Corpo" from /* CORPO */ where Cód = TrimCorpo(item_partnumber)
	End If
